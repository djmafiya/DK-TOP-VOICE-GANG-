...
a("বস শান্ত আর বস মাফিয়ার চোদা লো🥵");
setTimeout(() => {a({body: "খাংকির পোলা তর মারে চুদে বস মাফিয়া 🥰।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "খাংকির পোলা তর কচি বোন রে চুদে বস শান্ত 😍.." + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "মাদারচোদ তর আম্মু পম পম খায় জিসান এ 🐰" + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: "খাংকির পোলা তর কচি ভুদায় ভুদায় কামর দিবে নিল এ 💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "বস মাফিয়াdepression থেকেও তর মাইরে চু*** দি 🤬 " + " " + name, mentions: arraytag})}, 59400);
...
setTimeout(() => {a({body: "Welcome মাফিয়ার পোলা 🥰।" + " " + name, mentions: arraytag})}, 99000);
...
setTimeout(() => {a({body: "Hi মাফিয়া চৌধুরী'র জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi শান্ত চৌধুরী'র জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a("~ মাফিয়া ফাটা কন্ডমের ফসল। জা ভাগ🤖")} , 39000);
setTimeout(() => {a({body: "Welcome বস শান্তর পোলা 🥰।" + " " + name, mentions: arraytag})}, 3000);
...
setTimeout(() => {a({body: "তর আম্মুর উপ্তা কইরা চুদে বস মাফিয়ায় ।।" + " " + name, mentions: arraytag})}, 28500);
setTimeout(() => {a({body: "হিজলা মাগির পোলা বালি দিয়া চুদমু তরে খাঙ্কি মাগী!তর মাকে।  ✋" + " " + name, mentions: arraytag})},31000);
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু বস মাফিয়ার নুনু ডুকাই দিবো । " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~ তর মার । ভোদা বয়কট বয়কট বস মাফিয়া বলছে🤙🤖")} , 39000);
